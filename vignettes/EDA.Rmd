...
```{r plot_normality, fig.width = 5, fig.height = 3}
# Select columns by name
...
```{r plot_normality2, fig.width = 5, fig.height = 3}
carseats %>%
...
```{r plot_correlate, fig.width = 5, fig.height = 3}
...
```{r plot_correlate2, fig.width = 5, fig.height = 3}
# Select columns by name
...
```{r plot_correlate3, fig.width = 5, fig.height = 3, warning=FALSE}
carseats %>%
  filter(ShelveLoc == "Good") %>%
  group_by(Urban, US) %>%
...
```{r target_by3, fig.width = 5, fig.height = 3, warning=FALSE}
plot(cat_num)
```
...
```{r target_by5, fig.width = 5, fig.height = 3, warning=FALSE}
plot(cat_cat)
```
...
```{r target_by8, fig.width = 5, fig.height = 3, warning=FALSE}
plot(num_num)
```
...
```{r target_by8_2, fig.width = 5, fig.height = 3, warning=FALSE}
...
```{r target_by10, fig.width = 5, fig.height = 3, warning=FALSE}
plot(num_cat)
```
...
```{r plot_normality_dbi, fig.width = 5, fig.height = 3}
...
```{r plot_correlation_dbi, fig.width = 5, fig.height = 3}
# Extract only those with 'ShelveLoc' variable level is "Good",
...
```{r plot_target_by_dbi, fig.width = 5, fig.height = 3}
plot(cat_num)
```
