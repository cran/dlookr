...
## ----imputate_na, fig.width = 7, fig.height = 4--------------------------
...
## ----imputate_na2, fig.width = 7, fig.height = 4-------------------------
library(mice)
...
## ----imputate_outlier, fig.width = 7, fig.height = 4---------------------
...
## ----standardization, fig.width = 6, fig.height = 4----------------------
carseats %>% 
...
## ----resolving2, fig.width = 7, fig.height = 4---------------------------
...
## ----resolving3, fig.width = 7, fig.height = 4---------------------------
