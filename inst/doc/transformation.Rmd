...
```{r imputate_na, fig.width = 5, fig.height = 3}
...
```{r imputate_na2, fig.width = 5, fig.height = 3}
library(mice)
...
```{r imputate_outlier, fig.width = 5, fig.height = 3}
...
```{r standardization, fig.width = 5, fig.height = 3}
carseats %>% 
...
```{r resolving2, fig.width = 5, fig.height = 3}
...
```{r resolving3, fig.width = 5, fig.height = 3}
